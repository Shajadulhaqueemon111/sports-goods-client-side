...
const Navbar = () => {
  ...
  const navLink = (
    <>
      ...
      <li>
        <NavLink className=" font-bold" to="/all-product">
          All-Products
        </NavLink>
      </li>
      <li>
  ...
  return (
    <div>
      <div className="navbar z-10  bg-opacity-30 bg-black text-sky-400">
        <div className="navbar-start">
          ...
          <a className="btn btn-ghost text-xl">Sports Goods</a>
        </div>
